...
- Extracción automática de:
  ...
  - Porcentaje de IVA.
  - Nombre del comercio (por campo explícito o por heurística de primera línea).[file:3]
- Almacenamiento de todas las facturas en SQLite, incluyendo:
  - `chat_id` de Telegram (cada chat ve solo sus propias facturas).
  - Ruta local del PDF.
  - Fecha y hora de procesamiento.[file:2]
- Comandos para:
  ...
  - Exportar todo a un CSV compatible con Excel.[file:1][file:2]
- Soporte multiusuario/multi‑chat gracias al uso de `chat_id` en la base de datos.[file:1][file:2]
